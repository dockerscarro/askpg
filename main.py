...
if __name__ == "__main__":
    main()
This updated code includes input validation for task ID and error handling for database operations. It also checks if a task exists before updating or deleting it.