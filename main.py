...
if uploaded_file:
    if "uploaded_file_name" not in st.session_state or st.session_state.uploaded_file_name != uploaded_file.name:
        with st.spinner("📥 Parsing and inserting logs into database..."):
            ...
            if inserted_count > 0:
                st.success(f"✅ Inserted {insert_count} new log entries into PostgreSQL.")
...
In this updated code, I have moved the file uploader to the sidebar using `st.sidebar.file_uploader`. The rest of the code remains the same.